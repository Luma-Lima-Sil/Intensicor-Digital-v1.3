...
window.blockly.js.blockly.Agendamento.adicionarMes = function() {
 var listaMesAdd, item, existente, j, listaDatas, param, count, isValid, anoMes, mes, menorData, maiorData, objAgendamento, contador, i, retorno, numeroSemana;
...
window.blockly.js.blockly.Agendamento.removerDiaAgendamento = function(param) {
 var listaMesAdd, item, existente, j, listaDatas, count, isValid, anoMes, mes, menorData, maiorData, objAgendamento, contador, i, retorno, numeroSemana;
...
window.blockly.js.blockly.Agendamento.removerMes = function(mes, anoMes) {
 var listaMesAdd, item, existente, j, listaDatas, param, count, isValid, menorData, maiorData, objAgendamento, contador, i, retorno, numeroSemana;
  listaMesAdd = this.cronapi.screen.getScopeVariable('listaMeses');
  count = 1;
  for (var j_index in listaMesAdd) {
    j = listaMesAdd[j_index];
...
window.blockly.js.blockly.Agendamento.validarDatas = function(maiorData, menorData) {
 var listaMesAdd, item, existente, j, listaDatas, param, count, isValid, anoMes, mes, objAgendamento, contador, i, retorno, numeroSemana;
