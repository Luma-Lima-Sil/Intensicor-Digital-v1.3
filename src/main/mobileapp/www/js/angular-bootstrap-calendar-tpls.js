...
angular
  ...
  .controller('MwlDateModifierCtrl', ["$element", "$attrs", "$scope", "moment", "paintService", function($element, $attrs, $scope, moment, paintService) {
    ...
    function onClick() {
      ...
      $scope.$parent.$broadcast('updated-calendar-view', moment($scope.momentNewDate));
...
angular
  .module('mwl.calendar')
  .controller('MwlDynamicDirectiveTemplateCtrl', ["$compile", "$scope", "$attrs", "$element", "$templateCache", "$log", "calendarConfig", "paintService", "PlantaoAPIService", function($compile, $scope, $attrs, $element, $templateCache, $log, calendarConfig, paintService, PlantaoAPIService) {
