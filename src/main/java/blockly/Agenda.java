...
public static Var obterSemanas() throws Exception {
 return new Callable<Var>() {
   ...
   public Var call() throws Exception {
    listSemana = cronapi.list.Operations.newList(cronapi.object.Operations.newObject(Var.valueOf("app.dto.CorSemana"),Var.valueOf("id",Var.valueOf("1")),Var.valueOf("descricao",Var.valueOf("azul"))), cronapi.object.Operations.newObject(Var.valueOf("app.dto.CorSemana"),Var.valueOf("id",Var.valueOf("2")),Var.valueOf("descricao",Var.valueOf("vermelho"))), cronapi.object.Operations.newObject(Var.valueOf("app.dto.CorSemana"),Var.valueOf("id",Var.valueOf("3")),Var.valueOf("descricao",Var.valueOf("verde"))), cronapi.object.Operations.newObject(Var.valueOf("app.dto.CorSemana"),Var.valueOf("id",Var.valueOf("4")),Var.valueOf("descricao",Var.valueOf("cinza"))));
    return listSemana;
   }
 }.call();
}
